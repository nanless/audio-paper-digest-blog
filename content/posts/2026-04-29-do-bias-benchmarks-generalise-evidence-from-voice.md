...
![图1：MCQA行为缺乏向长篇输出迁移的示例](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-28/11461756-0.png)
图1说明：展示了SpeechLLM在经过MCQA“无偏见”微调后，在处理要求给出职业建议的长篇提示时，仍根据性别给出刻板建议（女性→护理，男性→医生）。

![图2：基线与“反刻板”微调模型在长篇任务各维度上的得分（95%置信区间）](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-28/11461756-1.png)
