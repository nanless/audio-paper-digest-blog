...
![图1: Overview of the PGCCL framework. Class-level prototypes are incorporated into each batch for pairwise cross-modal contrastive learning, structuring the representation space and improving modality alignment. EMA updates and mask distillation preserve historical knowledge, enabling stable incremental learning of new sound categories.](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11464249-0.png)
...
![图2: t-SNE visualization of all samples at the final incremental stage. Left: results from EWF baseline. Right: results using PGCCL. PGCCL produces clearer inter-modal boundaries and less overlap between modalities, indicating more structured multi-modal representations.](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11464249-1.png)
![图3: SDR and SIR across incremental learning stages. Our method consistently outperforms baselines.](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11464249-2.png)
