...
* 实验充分性 (1.3/1.5)：[A_RESULTS] 奖励评测、自动指标与人类偏好三层验证闭环完整，62.30% 对 27.63% 的人类偏好差距说服力强；不足是缺少标注者一致性报告与多种子方差。
...
* 可复现性 (0.4/0.5)：[A_REPRO] 训练三阶段、评测协议与后训练配置披露完整且有代码背书，主要门槛在 Gemini 数据构建成本与标注复刻。
