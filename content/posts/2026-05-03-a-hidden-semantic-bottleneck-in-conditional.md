...
![论文中的图片](/audio-paper-digest-blog/images/iclr-2026/2026-05-03/FetaeuGsEs-1.png)
...
1.  **条件嵌入相似度分析**：
    ...
    ![论文中的实验结果图](/audio-paper-digest-blog/images/iclr-2026/2026-05-03/FetaeuGsEs-2.png)
    *图3：使用REPA-XL模型计算的1000个类别的条件向量余弦相似度热力图。左图为全局视图，右图为随机10类的放大视图，显示超过99%的相似度。*

2.  **条件嵌入稀疏性分析**：
    - 通过幅度直方图和方差分析，展示大部分维度值接近于零。
    ![论文中的实验结果图](/audio-paper-digest-blog/images/iclr-2026/2026-05-03/FetaeuGsEs-4.png)
...
3.  **剪枝实验结果**：
    ...
    ![论文中的实验结果图](/audio-paper-digest-blog/images/iclr-2026/2026-05-03/FetaeuGsEs-7.png)
