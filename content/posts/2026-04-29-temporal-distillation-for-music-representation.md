...
![图1](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-28/11464051-0.png)
...
图表引用与说明：
![图2](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-28/11464051-1.png)
图2：预训练模型的时间连贯性验证。左图为预训练教师模型输出的相邻帧余弦相似度分布（红色），峰值接近0.85，表明高度连贯；右图为随机张量的分布（蓝色），接近0。此图证实了教师模型隐含了强大的时间先验，这是Harmonia方法成立的前提。

![图3](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-28/11464051-2.png)
