...
![VAP模型架构示意图](http://teb0hdrpn.hd-bkt.clouddn.com/icassp-2026/2026-04-29/11464984-0.png)
...
![S/H-Pred平衡准确率随测试信噪比的变化](http://teb0hdrpn.hd-bkt.clouddn.com/icassp-2026/2026-04-29/11464984-1.png)
（图2）
说明：图2A显示在纯净语音模型上测试时，随着噪声增加，韵律匹配噪声（绿线）的性能下降比背景噪声（蓝线）缓慢，且在低信噪比下仍能保持一定准确率。图2B显示混合训练提升了模型在各自操控条件下的鲁棒性，但对低信噪比的背景噪声（蓝线）改善有限。

![不同操控条件下的词错误率](http://teb0hdrpn.hd-bkt.clouddn.com/icassp-2026/2026-04-29/11464984-2.png)
（图3）
说明：图3量化了不同操控方式对语音可懂度的影响。韵律匹配噪声（绿色）的词错误率始终接近100%，证明词汇信息被完全去除。韵律平滑（橙色）对词错误率影响很小。背景噪声（蓝色）的词错误率随信噪比降低而升高。

![各操控条件模型性能相对于纯净语音模型的百分比](http://teb0hdrpn.hd-bkt.clouddn.com/icassp-2026/2026-04-29/11464984-3.png)
（图4）
