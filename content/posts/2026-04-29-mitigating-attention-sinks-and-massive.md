...
![图1: 不同任务和压缩率下的注意力沉降图](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11463794-0.png)
...
![图2: 中间注意力沉降的起源与大规模激活的来源](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11463794-1.png)
图2(a)显示中间注意力沉降从第2层之后开始出现。图2(b)通过分解第2层组件的贡献，证明大规模激活源自MLP模块。

![图3: 余弦相似度分析](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11463794-2.png)
图3(a)显示中间沉降token与BOS token的余弦相似度从第2层起就很高，而非沉降token则很低。图3(b)的成对余弦相似度热力图显示，沉降token（索引0, 20, 21）彼此高度相似，而与其他token正交。

![图4: 控制旋转实验的验证](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11463794-3.png)
