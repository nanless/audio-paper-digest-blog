...
![图1: TSDA框架示意图](/audio-paper-digest-blog/images/icassp-2026/2026-04-28/11463049-0.png)
...
可视化分析结果：
![图2: MOSI数据集上的T-SNE可视化](/audio-paper-digest-blog/images/icassp-2026/2026-04-28/11463049-1.png)
...
![图3: MOSI训练过程中的正则化曲线](/audio-paper-digest-blog/images/icassp-2026/2026-04-28/11463049-2.png)
图3：在CMU-MOSI训练过程中，正则化损失L_pur, L_decorr, L_orth的变化曲线。三者均呈单调下降并收敛，表明因子分离过程稳定有效，模型持续学到了更纯净、更独立的时空表征。

![图4: 超参数α, β, γ的敏感性分析](/audio-paper-digest-blog/images/icassp-2026/2026-04-28/11463049-3.png)
