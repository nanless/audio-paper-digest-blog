...
架构图说明：论文提供了两幅架构图。
![图1: DP调度机制在复合token上的可视化](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11462860-0.png)
图1清晰展示了DP机制的工作原理。水平轴是自回归时间步，垂直轴是子字段。可以看到，一个事件（例如事件$e_2$）的多个属性（type, beat, ...）被分散到相邻的时间步进行预测，箭头表示子字段之间潜在的依赖关系被显式建模。
![图2: 系统架构概览](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11462860-1.png)
...
![图3: 管弦乐生成MOS评分及95%置信区间](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11462860-2.png)
...
![图4: 三个测试提示的续写对比（左：无DP，右：有DP）](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11462860-3.jpg)
![图4续图](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11462860-4.jpg)
![图4续图](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11462860-5.jpg)
