...
原文实验段还出现可核对指标—数值 parameter=10、parameters=36、parameter=14、parameter=7、parameters=7、parameters=123、parameters=21、parameters=20；这些数字的完整指标定义、数据集和比较方向以原文表格为准，本文不替换其含义。
