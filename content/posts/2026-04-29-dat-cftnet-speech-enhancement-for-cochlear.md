...
![图1: DAT-CFTNet 整体架构与 DAT-RNN 模块](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-28/11463084-0.png)
...
图2（`![图2: CI电极刺激响应与频谱图](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-28/11463084-2.jpg)`）展示了在汽车噪声SNR 0dB条件下，原始、含噪和DAT-CFTNet-F处理后语音的频谱图和人工耳蜗电极图。结果显示，增强后的语音频谱更清晰，电极图保留了清晰的谐波结构，而噪声成分被有效抑制，证明了该方法对CI用户的潜在价值。
