...
* 实验充分性 (1.1/1.5)：[A_RESULTS] 双基准、三规格、四组消融覆盖了主要设计决策，但推理效率只有相对曲线，没有时延、吞吐或内存占用的量化表格，效率主张的验证弱于精度主张。
...
* 工程/实践价值 (0.9/1.5)：[A_ENGINEERING] 14M 参数达到 51.6 mAP 对算力受限的视听应用很有吸引力，分辨率作为吞吐旋钮的设计便于部署调优；缺绝对速度数据削弱了落地指导性。
