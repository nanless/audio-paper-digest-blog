...
![pdf-image-page2-idx0](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11464156-0.png)
...
剪枝模式分析（图2，图3）：
![pdf-image-page4-idx1](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11464156-1.png)
图2显示，在ASVspoof5数据集上剪枝至50%时，HP方法学习到的剪枝模式与基线方法（均匀剪枝）显著不同，表现为非均匀的、任务特定的结构。

![pdf-image-page4-idx2](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11464156-2.png)
...
正则化效应（图4）：
![pdf-image-page4-idx3](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11464156-3.png)
图4展示了在CN-Celeb和SpoofCeleb两个数据集上，模型性能随稀疏度变化呈“U型”曲线，表明中等程度的剪枝能起到正则化作用，提升模型泛化能力。

跨模型规模分析（图5）：
![pdf-image-page4-idx4](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11464156-4.png)
