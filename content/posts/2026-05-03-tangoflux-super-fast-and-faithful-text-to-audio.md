...
![TangoFlux整体训练流程图](https://nanless.github.io/audio-paper-digest-images/iclr-2026/2026-05-03/qgNs5NmQB7-0.png)
...
- 训练策略：
    - 预训练：在WavCaps上训练80个epoch，使用AdamW优化器（$\beta_1=0.9, \beta_2=0.95$），学习率$5 \times 10^{-4}$，线性warmup 2000步。批量大小80（5张A40 GPU，每卡16）。时间步$t$从logit-normal分布（均值0，方差1）采样。然后在AudioCaps上微调65个epoch得到TANGOFLUX-base。
...
2.  在线生成 vs 离线训练（Figure 2）：
    ![在线与离线CRPO性能轨迹图](https://nanless.github.io/audio-paper-digest-images/iclr-2026/2026-05-03/qgNs5NmQB7-1.png)
...
3.  $\mathcal{L}_{CRPO}$ vs $\mathcal{L}_{DPO-FM}$（Figure 3 & 4）：
    ![LCRPO与LDPO-FM性能对比图](https://nanless.github.io/audio-paper-digest-images/iclr-2026/2026-05-03/qgNs5NmQB7-2.png)
