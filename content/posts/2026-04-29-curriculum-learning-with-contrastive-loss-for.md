...
架构图引用与说明：
![图2：课程学习负样本选择流程图](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11462096-1.jpg)
图2详细展示了上述流程：教师网络提取锚点和负样本的嵌入，计算相似度得分并排序，根据节奏函数选择Q个最容易的样本，将索引传递给学生网络，学生网络利用这些负样本计算损失并反向传播。

![图1：课程学习示意图](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11462096-0.jpg)
...
![图3：节奏函数示意图](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11462096-2.jpg)
图3展示了三种节奏函数Q=f(t)随epoch增长的趋势：指数增长最快，线性居中，对数最慢。

![图4：节奏步数对性能的影响](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11462096-2.jpg) (论文中同一页面)
