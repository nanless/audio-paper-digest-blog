...
![SPADE框架概览](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-28/11462223-10.png)
...
相关图表：
![WER和余弦距离层重要性分析](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-28/11462223-10.png)
图2：展示了CosyVoice 2和LLaSA各层的WLI（WER变化）和CLI（余弦距离）。关键结论：基于WLI，位于模型起始、中部和末尾的层通常更关键；且WLI与CLI的模式不完全一致，支持了采用WLI作为剪枝指标的必要性。

![内存使用对比](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-28/11462223-10.png)
