...
实验结果图表：
![图1: 不同模型在FLEURS检索、FLEURS性别分类和SD-QA口音分类任务上随模型层深变化的性能。SONAR结果作为参考基线（仅最后一层）。](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-28/11464957-0.png)
