...
![图1](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-28/11463080-0.png)
...
![图2](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-28/11463080-1.png)
图2（RGA箱线图）显示：ECG和PCG单模态性能差异大且不稳定。三种融合方法（Fus, FuSE, FuSEmHR）的RGA中位数和稳定性（箱体范围）均优于单模态，且FuSEmHR最佳。

![图3](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-28/11463080-2.png)
图3（逐个受试者的RGA对比）显示：对于原始Fus方法表现较差的后半段受试者，FuSEmHR（红线）相比Fus（蓝线）有显著提升（绿色区域），表明其鲁棒性增强。左侧箱线图量化了这种提升幅度（多数为正向提升）。

![图4](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-28/11463080-3.png)
