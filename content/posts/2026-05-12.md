...
前25% | #空间音频 | #流匹配 | [arxiv](https://arxiv.org/abs/2605.10398v1)
...
#语音合成 | #自监督学习 #表示学习 #扩散模型 | #自监督学习 #音频编码 | [arxiv](https://arxiv.org/abs/2605.10084v1)
...
2.  **方法核心**：提出PoDAR框架，通过在自编码器（如VAE）训练中引入**随机功率增强**（在[-6, +6] dB范围内随机调整增益）和**潜空间一致性损失**（惩罚内容通道对功率增强的敏感度），显式地将音频表示分解为“功率子空间”（前k个通道）和“功率不变语义子空间”（剩余通道）。
