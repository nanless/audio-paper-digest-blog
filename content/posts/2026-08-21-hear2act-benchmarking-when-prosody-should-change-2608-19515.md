...
![Figure 1: Hear2Act overview. (1) Each scenario combines a surface request, prioritized hidden concerns, and candidates with verifiable satisfaction signatures. (2) Assistants interact under different feedback and access conditions. (3) Matched rollouts compare task outcomes and interaction behavior.](https://arxiv.org/html/2608.19515v1/hear2act_framework_crop.png)
...
| 真值关切状态 | 40.7% | 参考上界 |
| Claude Opus 4.6：转写→加状态标签 | OptSat 37.0%→41.1%，1st% 49.7%→79.1% | 文本模型对照 |
| Kimi K2.5：转写→加状态标签 | OptSat 27.7%→36.1%，1st% 27.9%→69.2% | 文本模型对照 |
