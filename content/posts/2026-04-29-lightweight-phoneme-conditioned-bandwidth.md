...
![PhonCon架构图](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11460573-0.png)
...
![Mamba残差块示意图](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11460573-1.png)
...
![语音质量指标分布](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11460573-2.png)
*   图3说明：展示了不同模型在测试集上PESQ和STOI分数的分布（箱线图）。可以直观地看到，条件化模型（FiLM/TFiLM变体）的分布中心和中位数普遍高于对应的非条件基线。

![性能与模型大小关系图](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11460573-3.png)
