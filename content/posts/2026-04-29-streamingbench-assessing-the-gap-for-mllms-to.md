...
![图2: 数据构建流程](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-28/11463959-1.png)
...
![图5: 线索类型分类](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-28/11463959-4.png)
...
![图6: SQA任务分析](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-28/11463959-5.png)
图6: 左图显示在序列问答（SQA）任务中，明确指代消解能略微提升模型性能，但仍远低于人类。右图显示将主动输出（PO）任务转化为被动问答后，性能显著提升。

![图7: 主动输出任务分析](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-28/11463959-6.png)
