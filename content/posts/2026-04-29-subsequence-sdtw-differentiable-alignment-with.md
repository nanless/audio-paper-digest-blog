...
![图1](http://teb0hdrpn.hd-bkt.clouddn.com/icassp-2026/2026-04-29/11463857-0.png)
（图1: 展示了边界不匹配的问题场景。a) 乐谱作为弱对齐目标。b) DNN的预测帧。c) 带有边界不确定性±∆的输入音频。d) subSDTW的代价矩阵，显示了具有灵活边界条件的对齐路径。）

其核心计算架构体现在前向和后向传播的动态规划递归中：
![图2](http://teb0hdrpn.hd-bkt.clouddn.com/icassp-2026/2026-04-29/11463857-1.png)
...
![图3](http://teb0hdrpn.hd-bkt.clouddn.com/icassp-2026/2026-04-29/11463857-2.png)
