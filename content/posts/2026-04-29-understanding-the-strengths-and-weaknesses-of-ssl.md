...
![图1: k值对验证集F1分数的影响](http://teb0hdrpn.hd-bkt.clouddn.com/icassp-2026/2026-04-29/11464412-0.png)
图1显示，随着邻居数k增加，检查点归因和架构归因的F1分数均先上升后趋于平稳。架构归因性能在两个SSL模型间差异不大，而wav2vec2在检查点归因上持续优于w2v-bert。

![图2: 基线混淆矩阵（使用w2v-bert-2.0特征）](http://teb0hdrpn.hd-bkt.clouddn.com/icassp-2026/2026-04-29/11464412-1.png)
