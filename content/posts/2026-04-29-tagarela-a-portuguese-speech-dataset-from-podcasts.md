...
![图1：TAGARELA预处理流水线概览](http://teb0hdrpn.hd-bkt.clouddn.com/icassp-2026/2026-04-29/11462137-0.png)
...
![图3：STOI, PESQ和SI-SDR的分布](http://teb0hdrpn.hd-bkt.clouddn.com/icassp-2026/2026-04-29/11462137-2.png)
*   说明：该图展示了经流水线处理后，TAGARELA数据集中音频片段的客观质量指标（STOI, PESQ, SI-SDR）分布。这些指标通常需要干净参考信号，此处使用了无参考估计。结果表明，经过降噪等处理后，数据集整体音频质量处于较高水平。

音频片段时长分布图（图2）

![图2：不同口音和性别下的音频片段时长分布](http://teb0hdrpn.hd-bkt.clouddn.com/icassp-2026/2026-04-29/11462137-1.png)
