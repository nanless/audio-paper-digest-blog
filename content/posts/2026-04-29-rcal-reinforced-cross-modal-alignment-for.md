...
![图1](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11461715-0.png)
...
2.  核心模块 - RCAL Block (迭代记忆精炼)：
    ...
    ![图2](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11461715-1.png)
...
可视化分析 (图3, 图4)：
![图3](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11461715-2.png)
图3展示了门控激活与音频-文本注意力。不同层的门控激活率不同（Layer 0: 0.51, Layer 1: 0.36, Layer 2: 0.71），表明模型能自适应调节不同层级的融合深度。音频-文本注意力在不同层关注不同的模态关系。
![图4](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11461715-3.png)
