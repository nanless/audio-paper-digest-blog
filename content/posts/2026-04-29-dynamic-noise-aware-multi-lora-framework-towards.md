...
如图1（`![图1: Dynamic Noise-Aware Multi LoRA framework architecture](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11463424-0.png)`)所示，DNA Multi LoRA框架是一个三阶段系统：
...
灾难性遗忘分析（图2）：
![图2: Sequential fine-tuning on D1→D7 showing performance degradation on cumulative previous domains.](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11463424-0.png)
...
特征可视化（图3）：
![图3: t-SNE visualization of feature representations from ConformerTCM under D5 (speech manipulation) noise domains: (a) baseline, (b) fine-tuned, and (c) D5-specific LoRA.](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11463424-0.png)
