...
![图4描述：在CS非独立同分布场景下，pFedMARL、Ditto、FedAvg和本地训练的平均验证准确率（上图）、服务器F1准确率（中图）以及平均动作值（下图）随通信轮数的变化曲线。](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11462172-3.png)
...
![图2描述：pFedMARL框架概览，展示了服务器端（绿色）和客户端（蓝色）的智能体如何基于观测和奖励，在环境中交互以调整模型聚合。](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11462172-1.png)
图2架构详解：
