...
![图6: 准确率与FLOPs、推理时间、FPS的关系](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-28/11462313-5.png)
图6显示，Lightweight 5配置（第3层裁剪50%）在准确率略有提升的同时，FLOPs和推理时间相比原始模型有所降低，验证了轻量化策略的有效性。

![图7: 类别混淆矩阵](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-28/11462313-6.png)
