...
架构图清晰地展示了上述数据流。![图2：Lisa整体框架](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11464260-0.png)
...
![图3：Inception残差块（IRB）结构](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11464260-0.png) (此图在原文中位于描述IRB的段落旁，但提供的图片列表中仅有一个URL，因此此处用文字说明。)
...
![图4：RVQ与R-RVQ的t-SNE可视化](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11464260-0.png) (此图在原文中用于说明问题，但提供的图片列表中仅有一个URL，因此此处用文字说明。)
...
![图5：RVQ与R-RVQ在各级VQ的RQE对比](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11464260-0.png) (此图在原文中用于展示关键结果，但提供的图片列表中仅有一个URL，因此此处用文字说明。)
