...
架构图：
![图2: 风格可控数据增强模型框架](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11462934-1.png)
该图清晰地展示了两阶段结构。第一阶段（上方）从文本和风格嵌入生成内容风格标记；第二阶段（下方）以这些标记和说话人嵌入为条件，通过流匹配解码器生成梅尔频谱图。

![图3: 整体说话人日志流程示意图](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11462934-2.png)
