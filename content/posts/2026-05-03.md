...
| 排名 | 论文 | 评分 | 分档 | 主任务 |
|------|------|------|------|------|
| 🥇 | [UniSonate: A Unified Model for Speech, Music, and Sound](https://arxiv.org/abs/2604.22209v1) | 8.5分 | 前25% | #音频生成 |
| 🥈 | [Beyond Acoustic Sparsity and Linguistic Bias: A Prompt-](https://arxiv.org/abs/2604.22133v1) | 8.5分 | 前25% | #发音错误检测 |
| 🥉 | [DM-ASR: Diarization-aware Multi-speaker ASR with Large ](https://arxiv.org/abs/2604.22467v1) | 8.0分 | 前25% | #说话人识别 |
| 4. | [Transformer-Based Rhythm Quantization of Performance MI](https://arxiv.org/abs/2604.22290v1) | 8.0分 | 前25% | #音乐信息检索 |
| 5. | [Audio Effect Estimation with DNN-Based Prediction and S](https://arxiv.org/abs/2604.22276v1) | 8.0分 | 前25% | #音乐理解 |
| 6. | [Listening with Time: Precise Temporal Awareness for Lon](https://arxiv.org/abs/2604.22245v1) | 8.0分 | 前25% | #音频场景理解 |
| 7. | [TTS-PRISM: A Perceptual Reasoning and Interpretable Spe](https://arxiv.org/abs/2604.22225v1) | 7.5分 | 前25% | #语音质量评估 |
| 8. | [Spectrographic Portamento Gradient Analysis: A Quantita](https://arxiv.org/abs/2604.22037v1) | 7.5分 | 前25% | #音乐信息检索 |
| 9. | [Advancing automatic speech recognition using feature fu](https://arxiv.org/abs/2604.22203) | 7.0分 | 前25% | #语音识别 |
| 10. | [Identifying and typifying demographic unfairness in pho](https://arxiv.org/abs/2604.22631v1) | 7.0分 | 前50% | #语音识别 |
| 11. | [Full-Duplex Interaction in Spoken Dialogue Systems: A C](https://arxiv.org/abs/2604.21406v2) | 6.5分 | 前25% | #语音对话系统 |
| 12. | [Audio Video Verbal Analysis (AVVA) for Capturing Classr](https://arxiv.org/abs/2604.22043v1) | 6.0分 | 前50% | #音频问答 |
| 13. | [Earable Platform with Integrated Simultaneous EEG Sensi](https://arxiv.org/abs/2604.22137v1) | 5.5分 | 后50% | #音频事件检测 |

---

## 📋 论文列表

### 🥇 [UniSonate: A Unified Model for Speech, Music, and Sound Effect Generation with Text Instructions](https://arxiv.org/abs/2604.22209v1)
...
### 🥈 [Beyond Acoustic Sparsity and Linguistic Bias: A Prompt-Free Paradigm for Mispronunciation Detection and Diagnosis](https://arxiv.org/abs/2604.22133v1)
...
### 🥉 [DM-ASR: Diarization-aware Multi-speaker ASR with Large Language Models](https://arxiv.org/abs/2604.22467v1)
...
### 4. [Transformer-Based Rhythm Quantization of Performance MIDI Using Beat Annotations](https://arxiv.org/abs/2604.22290v1)
...
### 5. [Audio Effect Estimation with DNN-Based Prediction and Search Algorithm](https://arxiv.org/abs/2604.22276v1)
...
### 6. [Listening with Time: Precise Temporal Awareness for Long-Form Audio Understanding](https://arxiv.org/abs/2604.22245v1)
...
### 7. [TTS-PRISM: A Perceptual Reasoning and Interpretable Speech Model for Fine-Grained Diagnosis](https://arxiv.org/abs/2604.22225v1)
...
### 8. [Spectrographic Portamento Gradient Analysis: A Quantitative Method for Historical Cello Recordings with Application to Beethoven's Piano and Cello Sonatas, 1930--2012](https://arxiv.org/abs/2604.22037v1)
...
### 9. [Advancing automatic speech recognition using feature fusion with self-supervised learning features: A case study on Fearless Steps Apollo corpus](https://arxiv.org/abs/2604.22203)
...
### 10. [Identifying and typifying demographic unfairness in phoneme-level embeddings of self-supervised speech recognition models](https://arxiv.org/abs/2604.22631v1)
...
### 11. [Full-Duplex Interaction in Spoken Dialogue Systems: A Comprehensive Study from the ICASSP 2026 HumDial Challenge](https://arxiv.org/abs/2604.21406v2)
...
### 12. [Audio Video Verbal Analysis (AVVA) for Capturing Classroom Dialogues](https://arxiv.org/abs/2604.22043v1)
...
### 13. [Earable Platform with Integrated Simultaneous EEG Sensing and Auditory Stimulation](https://arxiv.org/abs/2604.22137v1)
