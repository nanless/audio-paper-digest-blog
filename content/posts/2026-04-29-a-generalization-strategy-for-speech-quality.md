...
![图1: pdf-image-page4-idx0](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11464267-0.png)
...
![图2: pdf-image-page4-idx1](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11464267-1.png)
图2：SRCC对比。与MSE趋势一致，在同样的8个测试集上，SAM+Adam取得了更高的SRCC，表明模型排序与人类评价的一致性更好。例外情况（如NISQA FOR, LIVETALK, VMC‘23-1a, 1b）可能与语言差异有关。

图3（性能损失缓解） 分析：
![图3: pdf-image-page4-idx2](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11464267-2.png)
