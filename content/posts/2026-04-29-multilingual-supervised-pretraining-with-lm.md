...
![模型架构图](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11461766-0.png)
图1展示了整体架构。左侧是处理视频序列的3D-Stem ResNet-18视觉前端，中间是Conformer编码器，右侧是Transformer解码器。训练时，CTC和Attention的损失共同作用于编码器输出和解码器输出。

![渐进冻结策略图](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11461766-1.png)
...
![渐进冻结实验结果](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11461766-2.png)
