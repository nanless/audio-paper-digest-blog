...
![Figure 1: NAPE overview. The model predicts each next patch embedding from preceding spectrogram patches while a causal mask hides future patches; the right panel shows the encoder block.](https://arxiv.org/html/2608.19863v1/Architecture.png)
