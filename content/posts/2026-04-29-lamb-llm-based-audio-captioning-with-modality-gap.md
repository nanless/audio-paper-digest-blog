...
![图1：LAMB框架总体架构图](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11462125-0.jpg)
...
![图2：嵌入对齐可视化](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11462125-1.png)
图2 展示了使用跨模态对齐器（CMA）前后，音频嵌入与文本嵌入在二维空间的分布情况。可以清晰地看到，应用CMA后（蓝色点簇），音频嵌入与文本嵌入（绿色点簇）的分布从几乎完全分离变得紧密重合，直观验证了对齐效果。

![图3与图4：定性结果与对比](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11462125-2.jpg)
![图4](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11462125-3.jpg)
