...
![图1: pdf-image-page2-idx0](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11463023-0.png)
1.  输入：C个麦克风通道的音频。
2.  前端特征提取（多通道WavLM）：
...
![图2: pdf-image-page4-idx1](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11463023-1.png)
图2: 各种方法在不同阶段的推理时间比较。CA代表ChannelAttention。结果表明，所提方法（尤其是attentive argmax）显著比DOVER-Lap高效。

![图3: pdf-image-page4-idx2](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11463023-2.png)
图3: 在CHiME-6数据集上，通道注意力权重在帧和头维度上平均后的层间分布。不同层表现出不同的行为模式，表明模型在利用空间线索。

![图4: pdf-image-page4-idx3](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11463023-3.png)
