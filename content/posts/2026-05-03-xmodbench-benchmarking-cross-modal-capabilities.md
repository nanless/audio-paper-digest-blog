...
本文提出的是一个评估基准（Benchmark），而非一个新的端到端模型。因此，其“架构”指的是基准本身的设计框架。该框架围绕“跨模态一致性”这一核心概念构建，包含以下关键组件：
*   数据基础：对齐的文本-图像-音频三元组。
...
![图1: XModBench概述]](https://nanless.github.io/audio-paper-digest-images/iclr-2026/2026-05-03/HaL9EZovFg-0.png)
...
![图4: 模态差异分析]](https://nanless.github.io/audio-paper-digest-images/iclr-2026/2026-05-03/HaL9EZovFg-3.png)
...
![图5: 方向不平衡分析]](https://nanless.github.io/audio-paper-digest-images/iclr-2026/2026-05-03/HaL9EZovFg-4.png)
...
![图6: 失败案例]](https://nanless.github.io/audio-paper-digest-images/iclr-2026/2026-05-03/HaL9EZovFg-5.jpg)
![图7: 失败案例]](https://nanless.github.io/audio-paper-digest-images/iclr-2026/2026-05-03/HaL9EZovFg-6.jpg)
