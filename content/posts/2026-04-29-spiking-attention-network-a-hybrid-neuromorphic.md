...
![SA-Net架构图](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11464621-0.png)
图1展示了SA-Net的整体架构。输入信号依次经过Residual Blocks进行初步处理，然后通过LIF SNN层进行脉冲编码和时序整合，接着由Conformer Blocks进行上下文信息融合，最后通过MLP得到距离预测值。

![LIF神经元动力学与脉冲产生示意图](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11464621-1.png)
...
特征可视化（图3）：
![不同层输出热力图](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11464621-2.png)
