...
![图1: 基于物理信息的混合多项式神经网络（HPNN）架构](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11463905-0.png)
...
![图3: HPNN预测与真实输出在频率域的幅度与周期图差异](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11463905-2.png)
图3展示了LSK1（前两行）和LSK3（后两行）在语音激励下的频率域预测误差。颜色越接近白色表示误差越小。图中可见LSK1在低频区域误差较大，可能与电源噪声有关；而LSK2、LSK3在高频区域的误差被有效抑制，表明多项式层起了作用。

![图4: 时域模型输出对比：语音活跃与静默段](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11463905-3.png)
