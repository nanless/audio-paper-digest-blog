...
![图1: pdf-image-page2-idx0](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11464467-0.png)
...
![图2: pdf-image-page2-idx1](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11464467-1.png)
![图3: pdf-image-page2-idx2](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11464467-2.png)
...
![图4: pdf-image-page3-idx3](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11464467-3.png)
- 图4结论：热力图直观展示了不同方法在1-3个声源混合场景下的性能。本文模型（最后一列）的计数预测更准确，且定位结果围绕真实值形成更尖锐、集中的峰值，表明其精度和鲁棒性更优。

![图5: pdf-image-page4-idx4](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11464467-4.png)
