...
模型架构与数据流：
![模型流程图](http://teb0hdrpn.hd-bkt.clouddn.com/icassp-2026/2026-04-29/11464234-0.png)
...
实验图表：
![DOA误差随SNR和RT60变化图](http://teb0hdrpn.hd-bkt.clouddn.com/icassp-2026/2026-04-29/11464234-1.png)
图2：不同定位方法和SV模型的平均角度误差。(a) SNR变化 (b) RT60变化。SIRUP在噪声条件下性能接近真实HOA，但随混响增加优势减弱。

![波束图对比热图](http://teb0hdrpn.hd-bkt.clouddn.com/icassp-2026/2026-04-29/11464234-2.png)
