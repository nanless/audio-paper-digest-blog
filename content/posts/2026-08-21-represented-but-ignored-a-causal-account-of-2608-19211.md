...
![Figure 5: Two interventions at the lens-peak layer L∗L^{*}. (A) Direction injection. A class-mean direction d=μ+−μ−d=\mu^{+}-\mu^{-} is computed from positive- and negative-class L](https://arxiv.org/html/2608.19211v1/x4.png)
