...
![图1: pdf-image-page2-idx0](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11462251-0.png)
...
- 图2（波形对比）：直观展示了ViGAS生成的波形在左右声道过于平滑，与真实值差异大；而NVA-Former的预测波形在峰值和节奏上更接近真实值，说明其更好地捕捉了空间动态特性。
  ![图2: pdf-image-page4-idx1](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11462251-1.png)
- 图3（注意力可视化）：展示了目标视角声学特征对所有视觉特征的注意力分布。高注意力区域（红点）与说话人位置（蓝框）高度重合，直观证明了模型确实学到了视觉-声学的对应关系，无需显式标注。
  ![图3: pdf-image-page4-idx1](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11462251-1.png)
