...
![架构比较](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11464377-2.png)
...
![误差分布](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11464377-3.png)
图4：多模态大模型在零样本评估中的误差分布图。横轴为预测值减去真实值（误差），纵轴为核密度估计。可见Gemini-2.5-Pro的误差分布最窄（最稳定），但中位数略低于0；其他模型分布较宽，且Kimi-Audio的分布呈现多峰。

![预测散点图](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11464377-4.png)
