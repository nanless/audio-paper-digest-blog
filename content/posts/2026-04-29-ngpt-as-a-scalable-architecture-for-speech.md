...
架构图示例：
![图1：nGPT架构概览](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11461315-0.png)
图1展示了nGPT的完整流程：输入特征经线性子采样后进入nGPT编码器层堆叠，每个层包含RoPE、多头注意力、门控前馈模块，并全程应用超球面归一化。最后由Transformer解码器生成文本。

![图2：对称ALiBi偏置矩阵](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11461315-1.png)
...
长序列位置编码实验（图3）
![图3：长序列ASR中ALiBi与RoPE的对比](/audio-paper-digest-blog/images/icassp-2026/2026-04-29/11461315-2.png)
