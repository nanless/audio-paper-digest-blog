...
![图1: AMS-D训练流程](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11463787-0.png)
图1展示了AMS-D的整体框架：左侧为渐进式自蒸馏，t-1 epoch的教师模型提供logits用于计算蒸馏损失；右侧为注意力掩码策略，教师模型的最终层特征经Token权重模块生成掩码，应用于t epoch学生的输入，并加入了重建任务。

![图2: 掩码策略可视化](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11463787-1.png)
