...
![图2：GRNet整体架构图](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-28/11463932-1.jpg)
...
![图3：MOSI数据集上不同缺失率的性能对比](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-28/11463932-2.jpg)
图3显示，随着缺失率从0增加到0.9，GRNet（蓝线）的F1分数(a)始终保持最高，MAE(b)始终最低，表明其在不同噪声水平下均优于对比方法。

重建特征可视化（图4a-b）：
通过t-SNE可视化了在50%缺失率下，有无GRNet时重建特征与原始特征的分布。

![图4a-b：特征可视化对比](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-28/11463932-7.png)
