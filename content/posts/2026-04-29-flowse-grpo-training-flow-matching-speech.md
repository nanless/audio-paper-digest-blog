...
![Flow Matching SE模型结构](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11461623-0.png)
...
![GRPO后训练流程](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11461623-1.png)
...
![DNSMOS随训练步数变化](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11461623-2.png)
图2(a) 展示了不同噪声水平（a）下，DNSMOS分数随训练步数的变化。可见a=0.4（绿色）提升更快，但可能不稳定。
![说话人相似度随训练步数变化](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11461623-3.png)
图2(b) 展示了不同噪声水平下，说话人相似度随训练步数的变化。
![窗口训练效果](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11461623-4.png)
图2(c) 消融了窗口训练策略，显示仅在早期步骤（Fast）训练比全流程训练（Non-Fast）能更快提升奖励。
![SpeechBERTScore随训练步数变化](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-29/11461623-5.png)
