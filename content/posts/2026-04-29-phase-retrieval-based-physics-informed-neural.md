...
![图2: 模型架构图](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11460963-1.png)
...
![图4: 测试集数据损失对比](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11460963-3.png)
图4描述：展示了三种方法在不同频率和测量点数下的测试数据损失(Ldata)。结论：PRB-PINN在所有条件下损失最低。

![图6: PDE损失权重影响](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11460963-5.png)
图6描述：展示了λPDE=0, 0.001, 1时的Ldata和LPDE。结论：λPDE需要仔细权衡，过大的λPDE反而会损害数据重建精度。

![图5: 幅度分布可视化](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11460963-4.png)
