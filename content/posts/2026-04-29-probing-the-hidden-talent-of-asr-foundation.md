...
![图1: 模型整体框架](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-28/11463232-0.png)
...
1.  特征提取阶段：
    ...
    *   辅助特征提取：如图2所示，计算文本提示与转录文本的语义文本相似性（STS）分数，以及图像与转录文本的图像-文本对比性（ITC）分数。
        ![图2: 辅助特征提取示意图](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-28/11463232-0.png)
...
![图3: 声学和语言学嵌入的t-SNE可视化](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-28/11463232-2.png)
...
![图4: ITC和STS分数与人工评分的相关性](https://audio-paper-digest-images.bkt.clouddn.com/icassp-2026/2026-04-28/11463232-3.png)
