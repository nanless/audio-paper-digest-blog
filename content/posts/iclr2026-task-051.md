...
- 代码：论文中提到“将在论文发表后公开所有源代码和训练模型”，但当前文本中未提供具体的代码仓库链接。
...
- 引用的开源项目：论文构建于开源基础模型Qwen2.5-Omni-7B之上，并参考了Ke-Omni-R的代码库（作为训练基线）。
...
- 数据集：论文详细介绍了AudioMCQ数据集的构建方法和组成，但未提供下载链接或开源获取方式，表明数据集可能未公开。
- Demo：未提及在线演示。
