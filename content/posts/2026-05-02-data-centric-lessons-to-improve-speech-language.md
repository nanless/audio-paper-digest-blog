...
![模态分布差距分析](/audio-paper-digest-blog/images/iclr-2026/2026-05-02/4amNkYCDqX-4.png)
图5：不同数据策略下，模型在文本和语音条件下输出分布的反向KL散度分布。均值越低，模态对齐越好。Fine+Syn策略效果最佳。

![领域覆盖分析](/audio-paper-digest-blog/images/iclr-2026/2026-05-02/4amNkYCDqX-5.png)
