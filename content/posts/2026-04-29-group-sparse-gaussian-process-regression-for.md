...
![图1：NMSE (dB) 随频率变化图。Proposed方法在大部分频率范围内的NMSE显著低于PSD和MP-PSD基线方法，且对网格间隔更鲁棒。](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11464046-0.png)

定性结果（图2 & 描述中的图3）：
![图2：在2 kHz时，目标声场与各方法估计声场的实部对比（网格间隔δ=0.1m）。Proposed方法的估计结果（c）与目标声场（a）高度吻合，而PSD（b）和MP-PSD（d）的估计结果在声源附近及整个区域都存在明显失真。](https://nanless.github.io/audio-paper-digest-images/icassp-2026/2026-04-29/11464046-1.png)
