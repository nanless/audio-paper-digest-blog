...
![图1：ArEnAV数据生成流程图](/audio-paper-digest-blog/images/iclr-2026/2026-05-03/EbrPXZTVJ9-0.png)
...
![图2：数据集划分与语码转换分布](/audio-paper-digest-blog/images/iclr-2026/2026-05-03/EbrPXZTVJ9-1.png)
...
![图3：转录质量评估](/audio-paper-digest-blog/images/iclr-2026/2026-05-03/EbrPXZTVJ9-2.png)
...
![图4：BA-TFD+模型在伪造样本上的输出案例](/audio-paper-digest-blog/images/iclr-2026/2026-05-03/EbrPXZTVJ9-3.png)
**图4 描述**：展示了BA-TFD+模型在ArEnAV伪造样本上的定性结果。绿色区域为真实伪造片段，红色区域为模型预测的伪造片段。展示了正确分类但定位不准(a,b)和完全错误分类(c,d)的案例。

![图5：BA-TFD+模型在真实样本上的输出案例](/audio-paper-digest-blog/images/iclr-2026/2026-05-03/EbrPXZTVJ9-4.png)
