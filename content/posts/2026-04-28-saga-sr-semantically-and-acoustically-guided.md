...
![图1：SAGA-SR模型架构总览](/audio-paper-digest-blog/images/icassp-2026/2026-04-28/11460886-0.png)
...
![图2：不同模型生成音频的频谱图对比](/audio-paper-digest-blog/images/icassp-2026/2026-04-28/11460886-1.png)
图2显示，AudioSR和FlashSR的输出在高频区域（10kHz以上）能量分布不一致，且AudioSR有明显齿音伪影。SAGA-SR的频谱图与真实值（Ground Truth）更接近，高频结构更清晰、一致。

![图3：调整目标频谱滚降频率的效果](/audio-paper-digest-blog/images/icassp-2026/2026-04-28/11460886-2.png)
