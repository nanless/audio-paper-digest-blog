...
| 模型 / 设备条件 | macro F2↑ | 延迟↓ | 板级能量↓ |
|---|---:|---:|---:|
| WrenNet，1→10 物种 | 0.98→0.97 | 未报告 | 未报告 |
| mel_polychirp_x2，10 物种 | >0.94 | 未报告 | 未报告 |
| mel_cnn，nRF54 NPU INT8 | 未报告 | 22 ms | 低于 Pico 2 |
| mel_polychirp_x3，nRF54 NPU INT8 | 未报告 | 39 ms | 低于 Pico 2 |
| 对应操作，Pico 2 | 未报告 | 快 1.3–2.2× | 高 6.5–12× |
